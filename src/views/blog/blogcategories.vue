                        ...
                        <div class="page-header">
                            <div class="row">
                                ...
                                <div class="col-auto text-end">
                                    <a href="javascript:;" class="btn btn-primary btn-blog mb-3" data-bs-toggle="modal" data-bs-target="#blog-categories" ><i class="feather-plus-circle me-1"></i> Add New</a>
                                </div>
                            </div>
                        </div>
                        <!-- /Page Header -->
                                            ...
                                            <table class="table custom-table mb-0 datatables">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            <a href="javascript:;" class="table-action-btn btn btn-sm bg-success-light me-1" data-bs-toggle="modal" data-bs-target="#edit-blog-categories">
                                                                <i class="feather-edit-3 me-1"></i> Edit
                                                            </a>
                                                            <a href="javascript:;" class="table-action-btn btn btn-sm bg-danger-light" data-bs-toggle="modal" data-bs-target="#deleteModal">
                        ...
                        <div class="modal-body">
                            <div class="delete-wrap text-center">
                                ...
                                <div class="submit-section">
                                    <router-link to="/blog-categories" class="btn btn-success me-2">Yes</router-link>
