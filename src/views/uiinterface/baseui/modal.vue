                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="button-list">
                                    <!-- Standard  modal -->
                                    <button type="button" class="btn btn-primary mt-1 me-1" data-bs-toggle="modal" data-bs-target="#standard-modal">Standard Modal</button>
                                    <!-- Large modal -->
                                    <button type="button" class="btn btn-info mt-1 me-1" data-bs-toggle="modal" data-bs-target="#bs-example-modal-lg">Large Modal</button>
                                    <!-- Small modal -->
                                    <button  type="button" class="btn btn-success mt-1 me-1" data-bs-toggle="modal" data-bs-target="#bs-example-modal-sm">Small Modal</button>
                                    <!-- Full width modal -->
                                    <button  type="button" class="btn btn-primary mt-1 me-1" data-bs-toggle="modal" data-bs-target="#full-width-modal">Full width Modal</button>
                                    <!-- Scrollable modal -->
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="text-center mt-2 mb-4">
                                                    <div class="auth-logo">
                                                        <router-link to="index" class="logo logo-dark">
                                                            <span class="logo-lg">
                                                ...
                                                <form class="px-3" action="#">
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="form-check">
                                                            ...
                                                            <label class="form-check-label" for="customCheck1">I accept <a href="javascript:;">Terms and Conditions</a></label>
                                                        </div> 
                                                    </div>
                                ...
                                <div class="button-list">
                                    <!-- Sign Up modal -->
                                    <button type="button" class="btn btn-primary mt-1 me-1" data-bs-toggle="modal" data-bs-target="#signup-modal">Sign Up Modal</button>
                                    <!-- Log In modal -->
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="button-list">
                                    <!-- Top modal -->
                                    <button type="button" class="btn btn-secondary mt-1 me-1" data-bs-toggle="modal" data-bs-target="#top-modal">Top Modal</button>
                                    <!-- Bottom modal -->
                                    <button type="button" class="btn btn-secondary mt-1 me-1" data-bs-toggle="modal" data-bs-target="#bottom-modal">Bottom Modal</button>
                                    <!-- Center modal -->
                                    <button type="button" class="btn btn-secondary mt-1 me-1" data-bs-toggle="modal" data-bs-target="#centermodal">Center modal</button>
                                    <!-- Right modal -->
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="button-list">
                                    <!-- Success Alert modal --> 
                                    <button type="button" class="btn btn-success mt-1 me-1" data-bs-toggle="modal" data-bs-target="#success-alert-modal">Success Alert</button>
                                    <!-- Info Alert modal -->
                                    <button type="button" class="btn btn-info mt-1 me-1" data-bs-toggle="modal" data-bs-target="#info-alert-modal">Info Alert</button>
                                    <!-- Warning Alert modal -->
                                    <button  type="button" class="btn btn-warning mt-1 me-1" data-bs-toggle="modal" data-bs-target="#warning-alert-modal">Warning Alert</button>
                                    <!-- Danger Alert modal -->
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary waves-effect me-1" data-bs-dismiss="modal">Close</button>
                                ...
                                <div class="button-list">
                                    <!-- Responsive modal -->
                                    <button type="button" class="btn btn-success waves-effect waves-light mt-1 me-1" data-bs-toggle="modal" data-bs-target="#con-close-modal">Responsive Modal</button>
                                    <!-- Accordion modal -->
