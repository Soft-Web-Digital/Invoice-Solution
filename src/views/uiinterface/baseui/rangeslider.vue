    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                <rangesliderheader></rangesliderheader>
                <div class="row">
...
<script>
    ...
    <style>
    .slider-connect {
        background: var(--slider-connect-bg,#7638ff) !important;
        cursor: pointer;
    }
    ...
    .sharpskin .slider-base, .slider-connects {
        height: 2px;
        position: relative;
        width: 100%;
    }
    ...
    .squareskin .slider-base, .slider-connects {
        height: 4px;
        position: relative;
        width: 100%;
    }
    .slider-tooltip {
        background: var(--slider-tooltip-bg,#7638ff) !important;
        border: 1px solid var(--slider-tooltip-bg,#7638ff) !important;
    ...
    .rangeslider .slider-base, .slider-connects {
        height: 12px;
    }
    .rangeslider .slider-horizontal .slider-handle {
        ...
        top: calc((var(--slider-handle-height, 16px) - var(--slider-height, 6px))/2*-1 + 2px);
    ...
    .roundskin-slider .slider-horizontal .slider-handle {
        top: calc((var(--slider-handle-height, 30px) - var(--slider-height, 6px))/2*-1 + 2px);
        width: 24px;
        height: 24px;
        position: absolute;
        display: block;
    ...
    .squareskin-slider .slider-horizontal .slider-touch-area {
        top: calc((var(--slider-handle-height, 10px) - var(--slider-height, 6px))/2*-1 + 2px);
        width: 16px;
        height: 16px;
        position: absolute;
        display: block;
    ...
    .sharpskin-slider .slider-horizontal .slider-handle {
        top: calc((var(--slider-handle-height, 18px) - var(--slider-height, 6px))/2*-1 + 2px);
        width: var(--slider-handle-width,10px);
        height: 10px;
        position: absolute;
        display: block;
        background-color: #a804b2;
        box-shadow: var(--slider-handle-shadow,0.1px 0.1px 0px 0px rgba(0,0,0,.32));
        border-radius: 0px;
    }
