                    ...
                    <div class="col-md-6">	
                        <div class="card">
                            ...
                            <div class="card-body"> 
                                ...
                                <star-rating v-bind:star-size="20" v-bind:read-only="true" v-bind:rating="3" v-bind:show-rating="false"/>
                            </div>
                        </div>
                    </div>
                    <!-- /Rating -->
                    ...
                    <div class="col-md-6">	
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <star-rating v-bind:star-size="20" v-bind:increment="0.5" v-bind:rating="3.5" v-bind:show-rating="false"/>
                            </div>
                        </div>
                    </div>
                    <!-- /Rating -->
